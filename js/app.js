 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker-two]")) {
            const picker = datepicker_min("[data-datepicker-two]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        if (document.querySelector("[data-datepicker-three]")) {
            const picker = datepicker_min("[data-datepicker-three]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        if (document.querySelector("[data-datepicker-four]")) {
            const picker = datepicker_min("[data-datepicker-four]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        if (document.querySelector("[data-datepicker-five]")) {
            const picker = datepicker_min("[data-datepicker-five]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        if (document.querySelector("[data-datepicker-six]")) {
            const picker = datepicker_min("[data-datepicker-six]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        if (document.querySelector("[data-datepicker-eight]")) {
            const picker = datepicker_min("[data-datepicker-eight]", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
                customMonths: [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        function initSliders() {
            if (document.querySelector(".swiper-journey")) new swiper_core_Swiper(".swiper-journey", {
        ...
        function uploadFile(file) {
            ...
            reader.onload = function(e) {
                formPreview.textContent = "Прикреплён";
            };
